    ...
    public class MatrixRotate1Complete
    {
        ...
        public static void Rotate(ref int[,] matrix)
        {
            ...
            for (int ring = 0; ring < n / 2; ring++)
            {
                ...
                // top row of the ring.
                for (int leftrowcol = startrowcol; leftrowcol < endrowcol; ++leftrowcol)
                {
                    ...
                    int rightrowcol = endrowcol + startrowcol - leftrowcol;
                    ...
                    int topleft = matrix[startrowcol, leftrowcol];
                    ...
                    matrix[startrowcol, leftrowcol] = matrix[rightrowcol, startrowcol];
                    ...
                    matrix[rightrowcol, startrowcol] = matrix[endrowcol, rightrowcol];
