...
namespace CodingProblems.Array_.Sort
{
    ...
    /// </summary>
    [TestClass]
    public class ArraySortBubbleSortCompleteTests
    {
        /// <summary>
        /// Tests an array with an even number of elements.
        /// </summary>
        [TestMethod]
        public void ArraySortBubbleSortCompleteTestSimpleEven()
        {
            var nums = new List<int> { 56, 3, 7, 23, 5, 7, 8, 38 };
            ArraySortBubbleSortComplete.Sort(nums);
        ...
        /// </summary>
        [TestMethod]
        public void ArraySortBubbleSortCompleteTestSimpleOdd()
        {
        ...
        /// </summary>
        [TestMethod]
        public void ArraySortBubbleSortCompleteTestAlreadySorted()
        {
        ...
        /// </summary>
        [TestMethod]
        public void ArraySortBubbleSortCompleteTestAlmostAlreadySorted()
        {
        ...
        /// </summary>
        [TestMethod]
        public void ArraySortBubbleSortCompleteTestEmptyList()
        {
        ...
        /// </summary>
        [TestMethod]
        public void ArraySortBubbleSortCompleteTestSingleElement()
        {
        ...
        /// </summary>
        [TestMethod]
        public void ArraySortBubbleSortCompleteTestTwoElements()
        {
        ...
        /// </summary>
        [TestMethod]
        public void ArraySortBubbleSortCompleteTestNullList()
        {
            try
            {
                ArraySortBubbleSortComplete.Sort(null);
            }
            catch
            {
                Assert.IsTrue(true);
