...
namespace CodingProblems.Array_.FindMatchingPairs
{
    ...
    /// </summary>
    [TestClass]
    public class FindMatchingPairs1CharCountMapsCompleteTests
    {
        /// <summary>
        /// Tests FindMatchingPairs in the simple case.
        /// </summary>
        [TestMethod]
        public void FindMatchingPairs1CharCountMapsCompleteTestsTest1Simple()
        {
            // Initialize lists.
        ...
        /// </summary>
        [TestMethod]
        public void FindMatchingPairs1CharCountMapsCompleteTestsTest4NoMatches()
        {
            // Initialize lists.
        ...
        /// </summary>
        [TestMethod]
        public void FindMatchingPairs1CharCountMapsCompleteTestsTest5AllMatches()
        {
            // Initialize lists.
            var list1 = new List<int> { 1, 2, 8, 7, 5, 3 };
        ...
        /// </summary>
        [TestMethod]
        public void FindMatchingPairs1CharCountMapsCompleteTestsTest6EmptyLists()
        {
            // Initialize lists.
        ...
        /// </summary>
        [TestMethod]
        public void FindMatchingPairs1CharCountMapsCompleteTestsTest7EmptyList1()
        {
            // Initialize lists.
            var list1 = new List<int>();
            var list2 = new List<int> { 3, 4, 6, 4, 3 };
        ...
        /// </summary>
        [TestMethod]
        public void FindMatchingPairs1CharCountMapsCompleteTestsTest8EmptyList2()
        {
            // Initialize lists.
        ...
        /// </summary>
        [TestMethod]
        public void FindMatchingPairs1CharCountMapsCompleteTestsTest9NullList1()
        {
            try
            {
                FindMatchingPairs1CharCountMapsComplete.FindMatchingPairs(null, new List<int> { 1, 2, 4, 7, 8, 3 });
            }
        ...
        /// </summary>
        [TestMethod]
        public void FindMatchingPairs1CharCountMapsCompleteTestsTest10NullList2()
        {
            try
            {
                FindMatchingPairs1CharCountMapsComplete.FindMatchingPairs(new List<int> { 1, 2, 4, 7, 8, 3 }, null);
            }
            catch (ArgumentException)
            {
                Assert.IsTrue(true);
