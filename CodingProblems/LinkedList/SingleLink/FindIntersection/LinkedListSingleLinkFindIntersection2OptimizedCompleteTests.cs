...
{
    /// <summary>
    /// Tests LinkedListSingleLinkIntersection1Complete.FindIntersection.
    /// </summary>
    [TestClass]
    public class LinkedListSingleLinkFindIntersection2OptimizedCompleteTests
    {
        /// <summary>
        /// Tests the case in which the lists intersect.
        /// </summary>
        [TestMethod]
        public void LinkedListSingleLinkFindIntersection2OptimizedCompleteTest1IntersectionFound()
        {
            ...
            // Do check.
            Assert.AreEqual(common1, LinkedListSingleLinkFindIntersection2OptimizedComplete.FindIntersection(first1, first2));
        }
        ...
        /// </summary>
        [TestMethod]
        public void LinkedListSingleLinkFindIntersection2OptimizedCompleteTest4NullList1()
        {
            var first2 = new LinkedListSingleLinkNode<int>
            {
                Value = 21
            ...
            // Do check.
            Assert.AreEqual(null, LinkedListSingleLinkFindIntersection2OptimizedComplete.FindIntersection(null, first2));
        }
        ...
        /// </summary>
        [TestMethod]
        public void LinkedListSingleLinkFindIntersection2OptimizedCompleteTest6NullListBoth()
        {
            Assert.AreEqual(null, LinkedListSingleLinkFindIntersection2OptimizedComplete.FindIntersection(null, null));
        }
    }
}
