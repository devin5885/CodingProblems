...
namespace CodingProblems.MultipleStacksUsingSingleArray
{
    ...
    public class MultipleStacksUsingSingleArray1FixedSizeComplete<T>
    {
        ...
        ///
        /// Note that StackPointer must be adjusted bt the StackPointerOffset to be accurate.
        /// </summary>
        ...
        /// <summary>
        /// Gets the count of items in the specifed stack.
        /// </summary>
