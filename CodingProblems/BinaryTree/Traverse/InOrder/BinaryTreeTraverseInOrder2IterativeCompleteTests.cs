...
namespace CodingProblems.BinaryTree.Traverse.InOrder
{
    ...
    public class BinaryTreeTraverseInOrder2IterativeCompleteTests
    {
        ...
        public void InOrderTestTree1()
        {
            ...
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(BinaryTreeNodeTestData.Tree1);
        ...
        public void InOrderTestTree2()
        {
            ...
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(BinaryTreeNodeTestData.Tree2);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void InOrderTestTree3()
        {
            ...
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(BinaryTreeNodeTestData.Tree3);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void InOrderTestTree4()
        {
            ...
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(BinaryTreeNodeTestData.Tree4);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void InOrderTestTree5()
        {
            ...
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(BinaryTreeNodeTestData.Tree5);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void InOrderTestTree6()
        {
            ...
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(BinaryTreeNodeTestData.Tree6);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void InOrderTestTree7()
        {
            ...
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(BinaryTreeNodeTestData.Tree7);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void InOrderTestTree8()
        {
            ...
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(BinaryTreeNodeTestData.Tree8);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void InOrderTestTree9()
        {
            ...
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(BinaryTreeNodeTestData.Tree9);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void InOrderTestTree10()
        {
            ...
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(BinaryTreeNodeTestData.Tree10);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void InOrderTestTree11()
        {
            ...
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(BinaryTreeNodeTestData.Tree11);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void InOrderTestTree12()
        {
            ...
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(BinaryTreeNodeTestData.Tree12);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void InOrderTestTree13()
        {
            ...
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(BinaryTreeNodeTestData.Tree13);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        public void InOrderTestTree14()
        {
            ...
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(BinaryTreeNodeTestData.Tree14);
            CollectionAssert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = BinaryTreeTraverseInOrder2IterativeComplete.TraverseInOrder(null);
