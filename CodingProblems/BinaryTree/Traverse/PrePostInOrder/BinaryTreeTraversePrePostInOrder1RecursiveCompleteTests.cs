...
namespace CodingProblems.BinaryTree.Traverse.PrePostInOrder
{
    ...
    /// </summary>
    [TestClass]
    public class BinaryTreeTraversePrePostInOrder1RecursiveCompleteTests
    {
        /// <summary>
        ...
        {
            var actual = BinaryTreeTraversePrePostInOrder1RecursiveComplete.Traverse(data.Root, TraversalType.PreOrder);
        ...
        {
            var actual = BinaryTreeTraversePrePostInOrder1RecursiveComplete.Traverse(data.Root, TraversalType.InOrder);
        ...
        {
            var actual = BinaryTreeTraversePrePostInOrder1RecursiveComplete.Traverse(data.Root, TraversalType.PostOrder);
